...
namespace handrecognition_coefficient
{
    ...
    const dl::Filter<int16_t> *get_sequential_1_conv2d_4_biasadd_filter();
    const dl::Bias<int16_t> *get_sequential_1_conv2d_4_biasadd_bias();
    const dl::Activation<int16_t> *get_sequential_1_conv2d_4_biasadd_activation();
    const dl::Filter<int16_t> *get_sequential_1_conv2d_5_biasadd_filter();
    const dl::Bias<int16_t> *get_sequential_1_conv2d_5_biasadd_bias();
    const dl::Activation<int16_t> *get_sequential_1_conv2d_5_biasadd_activation();
